...
public class MsgList {
    ...
    public static final String requestDelPath = "Indica la ruta absoluta que se quiere eliminar o su número.";
    ...
    public static final String errorDelPathNumber = "Debe elegir un número entre 0 y ";
